...
_BASE_CONFIGS: Dict[str, DivisionConfig] = {
    "hardware": DivisionConfig(
        ...
        component_weights={"vertical": 0.30, "size": 0.00, "adoption": 0.50, "relationship": 0.20},
        size_revenue_column="Total Hardware + Consumable Revenue",
        size_revenue_fallback="revenue_estimate",
        adoption=AdoptionConfig(
    ...
    "cre": DivisionConfig(
        ...
        component_weights={"vertical": 0.25, "size": 0.00, "adoption": 0.45, "relationship": 0.30},
        size_revenue_column="revenue_estimate",
